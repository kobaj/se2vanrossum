...
(check-expect (check-one-solution 0 5 #\o '("wordses" (0 0) (0 6))) nil)
(check-expect (check-one-solution 0 1 #\o '("wordses" (0 0) (0 6))) #\o)
(check-expect (check-one-solution 0 1 #\o '("wordses" (0 6) (0 0))) nil)
(check-expect (check-one-solution 0 5 #\o '("wordses" (0 6) (0 0))) #\o)

; reversing left and right
(check-expect (check-one-solution 5 2 #\o '("wordses" (0 2) (8 2))) nil)
(check-expect (check-one-solution 1 2 #\o '("wordses" (0 2) (8 2))) #\o)
(check-expect (check-one-solution 1 2 #\o '("wordses" (8 2) (0 2))) nil)
(check-expect (check-one-solution 5 2 #\o '("wordses" (8 2) (0 2))) #\o)

; final big test
(check-expect (check-solution 5 2 #\o '(("wordses" (8 2) (0 2)))) #\o)
(check-expect (check-solution 5 2 #\o '(("zzzzzzz" (8 2) (0 2))
                                        ("wordses" (8 2) (0 2))
                                        ("aaaaaaa" (8 2) (0 2)))) #\o)
(check-expect (check-solution 5 2 #\o '(("zzzzzzz" (8 2) (0 2))
                                        ("bbbbbbb" (8 2) (0 2))
                                        ("wordses" (8 2) (0 2)))) #\o)
(check-expect (check-solution 5 2 #\o '(("wordses" (8 2) (0 2))
                                        ("bbbbbbb" (8 2) (0 2))
                                        ("ccccccc" (8 2) (0 2)))) #\o)
(check-expect (check-solution 5 2 #\o '(("qqqqqqq" (8 2) (0 2))
                                        ("bbbbbbb" (8 2) (0 2))
                                        ("ccccccc" (8 2) (0 2)))) nil)

(check-expect (check-solution-entry 5 2 "o" '(("zzzzzzz" (8 2) (0 2))
                                        ("wordses" (8 2) (0 2))
                                        ("aaaaaaa" (8 2) (0 2)))) #\o)